# 🎲 Engenharia de Dados → Setor Farmacêutico | NTT DATA + Cesar School


Projeto de Engenharia de Dados para o Setor Farmacêutico, desenvolvido na Cesar School em parceria com a NTT Data.
A solução utiliza Databricks, Python, SQL e PySpark para ingestão, tratamento, análise e modelagem de dados em um ambiente moderno de Lakehouse.
